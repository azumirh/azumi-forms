...
<div style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden">
  <div style="background:linear-gradient(135deg,#031D38 0%,#052E5A 60%,#0A3F7A 100%);padding:22px 28px">
    ...
    <div style="color:rgba(147,197,253,.8);font-size:11px;letter-spacing:.1em;text-transform:uppercase">Azumi RH · Form Builder</div>
  </div>
  ...
  <div style="padding:16px 28px;border-top:1px solid #EDEDED;font-size:10px;color:#778082;letter-spacing:.05em">
